...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CatalogItem', 'model/CatalogItemType', 'model/CredentialsStoredInServer', 'model/CredentialsSuppliedByUser', 'model/DataModelDataSource', 'model/Subscription'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CatalogItem'), require('./CatalogItemType'), require('./CredentialsStoredInServer'), require('./CredentialsSuppliedByUser'), require('./DataModelDataSource'), require('./Subscription'));
  } else {
    // Browser globals (root is window)
    if (!root.PowerBiReportServerRestApi) {
      root.PowerBiReportServerRestApi = {};
    }
    root.PowerBiReportServerRestApi.DataSource = factory(root.PowerBiReportServerRestApi.ApiClient, root.PowerBiReportServerRestApi.CatalogItem, root.PowerBiReportServerRestApi.CatalogItemType, root.PowerBiReportServerRestApi.CredentialsStoredInServer, root.PowerBiReportServerRestApi.CredentialsSuppliedByUser, root.PowerBiReportServerRestApi.DataModelDataSource, root.PowerBiReportServerRestApi.Subscription);
  }
}(this, function(ApiClient, CatalogItem, CatalogItemType, CredentialsStoredInServer, CredentialsSuppliedByUser, DataModelDataSource, Subscription) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('DataModelDataSource'))
        obj.dataModelDataSource = DataModelDataSource.constructFromObject(data['DataModelDataSource']);
      if (data.hasOwnProperty('DataSourceSubType'))
        obj.dataSourceSubType = ApiClient.convertToType(data['DataSourceSubType'], 'String');
  ...
  /**
   * @member {module:model/DataModelDataSource} dataModelDataSource
   */
  exports.prototype.dataModelDataSource = undefined;

  /**
   * Subtype of the datasource type. Applies to PowerBIReports. Ignored when used with DataSets, LinkedReports, and Reports.
   * @member {String} dataSourceSubType
   */
  exports.prototype.dataSourceSubType = undefined;
