# PowerBiReportServerRestApi.DataSourcesApi
...
var apiInstance = new PowerBiReportServerRestApi.DataSourcesApi();

var dataSource = new PowerBiReportServerRestApi.DataSource(); // DataSource | The definition of the new DataSource CatalogItem.
...
var dataSource = new PowerBiReportServerRestApi.DataSource(); // DataSource | The definition of data source.  Must contain connectionstring, data provider, and credentials to connect to the data source. In case of embedded data sources, Name will be null.
...
var opts = { 
  'queryFieldsRequest': new PowerBiReportServerRestApi.QueryFieldsRequest() // QueryFieldsRequest | 
};
...
var dataSource = new PowerBiReportServerRestApi.DataSource(); // DataSource | Definition of the DataSource item that updates the current item on the server. It is only necessary to include properties to be updated. All other property values on the CatalogItem will be left unchanged.
...
# **uploadDataSource**
> DataSource uploadDataSource(id, file)
...
apiInstance.uploadDataSource(id, file, callback);
```
