...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataDataSetRows', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ODataDataSetRows();
      });

      it('should create an instance of ODataDataSetRows', function() {
        // TODO: update the code to test ODataDataSetRows
        expect(instance).to.be.a(PowerBiReportServerRestApi.ODataDataSetRows);
      });
