...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExcelWorkbook', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ExcelWorkbook();
      });

      it('should create an instance of ExcelWorkbook', function() {
        // TODO: update the code to test ExcelWorkbook
        expect(instance).to.be.a(PowerBiReportServerRestApi.ExcelWorkbook);
      });
