...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataSetRow', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.DataSetRow();
      });

      it('should create an instance of DataSetRow', function() {
        // TODO: update the code to test DataSetRow
        expect(instance).to.be.a(PowerBiReportServerRestApi.DataSetRow);
      });
