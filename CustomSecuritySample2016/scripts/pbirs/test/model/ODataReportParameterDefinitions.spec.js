...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataReportParameterDefinitions', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ODataReportParameterDefinitions();
      });
      ...
      it('should create an instance of ODataReportParameterDefinitions', function() {
        ...
        expect(instance).to.be.a(PowerBiReportServerRestApi.ODataReportParameterDefinitions);
      });
