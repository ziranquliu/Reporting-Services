...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataExcelWorkbooks', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ODataExcelWorkbooks();
      });

      it('should create an instance of ODataExcelWorkbooks', function() {
        // TODO: update the code to test ODataExcelWorkbooks
        expect(instance).to.be.a(PowerBiReportServerRestApi.ODataExcelWorkbooks);
      });
