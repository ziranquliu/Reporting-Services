...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharedDataSets', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.SharedDataSets();
      });

      it('should create an instance of SharedDataSets', function() {
        // TODO: update the code to test SharedDataSets
        expect(instance).to.be.a(PowerBiReportServerRestApi.SharedDataSets);
      });
