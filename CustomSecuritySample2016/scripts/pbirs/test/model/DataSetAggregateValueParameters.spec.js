...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataSetAggregateValueParameters', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.DataSetAggregateValueParameters();
      });
      ...
      it('should create an instance of DataSetAggregateValueParameters', function() {
        ...
        expect(instance).to.be.a(PowerBiReportServerRestApi.DataSetAggregateValueParameters);
      });
