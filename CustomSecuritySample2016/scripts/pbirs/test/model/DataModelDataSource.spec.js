...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataModelDataSource', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.DataModelDataSource();
      });

      it('should create an instance of DataModelDataSource', function() {
        // TODO: update the code to test DataModelDataSource
        expect(instance).to.be.a(PowerBiReportServerRestApi.DataModelDataSource);
      });
      ...
      it('should have the property supportedAuthTypes (base name: "SupportedAuthTypes")', function() {
        // TODO: update the code to test the property supportedAuthTypes
        expect(instance).to.have.property('supportedAuthTypes');
        // expect(instance.supportedAuthTypes).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property modelConnectionName (base name: "ModelConnectionName")', function() {
        // TODO: update the code to test the property modelConnectionName
        expect(instance).to.have.property('modelConnectionName');
        // expect(instance.modelConnectionName).to.be(expectedValueLiteral);
      });
