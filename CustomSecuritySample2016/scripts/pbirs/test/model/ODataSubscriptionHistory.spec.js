...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataSubscriptionHistory', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ODataSubscriptionHistory();
      });

      it('should create an instance of ODataSubscriptionHistory', function() {
        // TODO: update the code to test ODataSubscriptionHistory
        expect(instance).to.be.a(PowerBiReportServerRestApi.ODataSubscriptionHistory);
      });
