...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataPowerBIReports', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ODataPowerBIReports();
      });

      it('should create an instance of ODataPowerBIReports', function() {
        // TODO: update the code to test ODataPowerBIReports
        expect(instance).to.be.a(PowerBiReportServerRestApi.ODataPowerBIReports);
      });
