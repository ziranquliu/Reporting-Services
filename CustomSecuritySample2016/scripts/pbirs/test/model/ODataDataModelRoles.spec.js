...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataDataModelRoles', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.ODataDataModelRoles();
      });

      it('should create an instance of ODataDataModelRoles', function() {
        // TODO: update the code to test ODataDataModelRoles
        expect(instance).to.be.a(PowerBiReportServerRestApi.ODataDataModelRoles);
      });
