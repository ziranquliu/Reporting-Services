...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SharedDataSetPath', function() {
      beforeEach(function() {
        instance = new PowerBiReportServerRestApi.SharedDataSetPath();
      });

      it('should create an instance of SharedDataSetPath', function() {
        // TODO: update the code to test SharedDataSetPath
        expect(instance).to.be.a(PowerBiReportServerRestApi.SharedDataSetPath);
      });
