...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CacheOptions', 'model/Comment', 'model/DataSet', 'model/DataSource', 'model/DataSourceCheckResult', 'model/HistorySnapshot', 'model/HistorySnapshotOptions', 'model/ItemPolicy', 'model/ODataAllowedActions', 'model/ODataCacheRefreshPlans', 'model/ODataComments', 'model/ODataDataSources', 'model/ODataDependentItems', 'model/ODataProperties', 'model/ODataReportParameterDefinitions', 'model/ODataReports', 'model/OdataError', 'model/Property', 'model/Report', 'model/ReportParameterDefinitionPatch', 'model/SharedDataSets', 'model/Subscription', 'model/UpdateCacheSnapshotResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CacheOptions'), require('../model/Comment'), require('../model/DataSet'), require('../model/DataSource'), require('../model/DataSourceCheckResult'), require('../model/HistorySnapshot'), require('../model/HistorySnapshotOptions'), require('../model/ItemPolicy'), require('../model/ODataAllowedActions'), require('../model/ODataCacheRefreshPlans'), require('../model/ODataComments'), require('../model/ODataDataSources'), require('../model/ODataDependentItems'), require('../model/ODataProperties'), require('../model/ODataReportParameterDefinitions'), require('../model/ODataReports'), require('../model/OdataError'), require('../model/Property'), require('../model/Report'), require('../model/ReportParameterDefinitionPatch'), require('../model/SharedDataSets'), require('../model/Subscription'), require('../model/UpdateCacheSnapshotResult'));
  } else {
    // Browser globals (root is window)
    if (!root.PowerBiReportServerRestApi) {
      root.PowerBiReportServerRestApi = {};
    }
    root.PowerBiReportServerRestApi.ReportsApi = factory(root.PowerBiReportServerRestApi.ApiClient, root.PowerBiReportServerRestApi.CacheOptions, root.PowerBiReportServerRestApi.Comment, root.PowerBiReportServerRestApi.DataSet, root.PowerBiReportServerRestApi.DataSource, root.PowerBiReportServerRestApi.DataSourceCheckResult, root.PowerBiReportServerRestApi.HistorySnapshot, root.PowerBiReportServerRestApi.HistorySnapshotOptions, root.PowerBiReportServerRestApi.ItemPolicy, root.PowerBiReportServerRestApi.ODataAllowedActions, root.PowerBiReportServerRestApi.ODataCacheRefreshPlans, root.PowerBiReportServerRestApi.ODataComments, root.PowerBiReportServerRestApi.ODataDataSources, root.PowerBiReportServerRestApi.ODataDependentItems, root.PowerBiReportServerRestApi.ODataProperties, root.PowerBiReportServerRestApi.ODataReportParameterDefinitions, root.PowerBiReportServerRestApi.ODataReports, root.PowerBiReportServerRestApi.OdataError, root.PowerBiReportServerRestApi.Property, root.PowerBiReportServerRestApi.Report, root.PowerBiReportServerRestApi.ReportParameterDefinitionPatch, root.PowerBiReportServerRestApi.SharedDataSets, root.PowerBiReportServerRestApi.Subscription, root.PowerBiReportServerRestApi.UpdateCacheSnapshotResult);
  }
}(this, function(ApiClient, CacheOptions, Comment, DataSet, DataSource, DataSourceCheckResult, HistorySnapshot, HistorySnapshotOptions, ItemPolicy, ODataAllowedActions, ODataCacheRefreshPlans, ODataComments, ODataDataSources, ODataDependentItems, ODataProperties, ODataReportParameterDefinitions, ODataReports, OdataError, Property, Report, ReportParameterDefinitionPatch, SharedDataSets, Subscription, UpdateCacheSnapshotResult) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the updateReportDataSets operation.
     * @callback module:api/ReportsApi~updateReportDataSetsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The key (GUID or path) that uniquely identifies the object. GUID example: 01234567-89ab-cdef-0123-456789abcdef path example: path='/folder1/folder2/item' If the path itself contains single quote, it should be escaped - add another single quote.
     * @param {module:model/SharedDataSets} dataSets Shared datasets to be used by specified report
     * @param {module:api/ReportsApi~updateReportDataSetsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateReportDataSets = function(id, dataSets, callback) {
      var postBody = dataSets;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateReportDataSets");
      }

      // verify the required parameter 'dataSets' is set
      if (dataSets === undefined || dataSets === null) {
        throw new Error("Missing the required parameter 'dataSets' when calling updateReportDataSets");
      }
    ...
    /**
     * Callback function to receive the result of the uploadReport operation.
     * @callback module:api/ReportsApi~uploadReportCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Report} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ReportsApi~uploadReportCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Report}
     */
    this.uploadReport = function(id, file, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling uploadReport");
      }

      // verify the required parameter 'file' is set
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling uploadReport");
      }
