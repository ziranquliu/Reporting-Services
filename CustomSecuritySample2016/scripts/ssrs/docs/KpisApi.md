# SqlServer2017ReportingServicesRestApi.KpisApi
...
var apiInstance = new SqlServer2017ReportingServicesRestApi.KpisApi();

var kpi = new SqlServer2017ReportingServicesRestApi.Kpi(); // Kpi | The definition of the new KPI CatalogItem.
...
var kpi = new SqlServer2017ReportingServicesRestApi.Kpi(); // Kpi | Definition of the KPI item that updates the current item on the server. It is only necessary to include properties to be updated. All other property values will be left unchanged.
