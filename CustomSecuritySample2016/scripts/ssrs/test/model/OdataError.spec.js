...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OdataError', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.OdataError();
      });

      it('should create an instance of OdataError', function() {
        // TODO: update the code to test OdataError
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.OdataError);
      });
