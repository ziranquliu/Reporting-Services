...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FavoriteItem', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.FavoriteItem();
      });

      it('should create an instance of FavoriteItem', function() {
        // TODO: update the code to test FavoriteItem
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.FavoriteItem);
      });
