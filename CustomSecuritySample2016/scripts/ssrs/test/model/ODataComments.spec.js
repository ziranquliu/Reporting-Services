...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataComments', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataComments();
      });

      it('should create an instance of ODataComments', function() {
        // TODO: update the code to test ODataComments
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataComments);
      });
