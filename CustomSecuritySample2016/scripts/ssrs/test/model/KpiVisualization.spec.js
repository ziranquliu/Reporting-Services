...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KpiVisualization', function() {
      beforeEach(function() {
        instance = SqlServer2017ReportingServicesRestApi.KpiVisualization;
      });

      it('should create an instance of KpiVisualization', function() {
        // TODO: update the code to test KpiVisualization
      ...
      it('should have the property bar', function() {
        expect(instance).to.have.property('bar');
        expect(instance.bar).to.be("Bar");
      });

      it('should have the property line', function() {
        expect(instance).to.have.property('line');
        expect(instance.line).to.be("Line");
      });

      it('should have the property step', function() {
        expect(instance).to.have.property('step');
        expect(instance.step).to.be("Step");
      });

      it('should have the property area', function() {
