...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataKpis', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataKpis();
      });

      it('should create an instance of ODataKpis', function() {
        // TODO: update the code to test ODataKpis
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataKpis);
      });
