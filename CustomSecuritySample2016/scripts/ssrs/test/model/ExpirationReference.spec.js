...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExpirationReference', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ExpirationReference();
      });

      it('should create an instance of ExpirationReference', function() {
        // TODO: update the code to test ExpirationReference
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ExpirationReference);
      });
