...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemPolicy', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.SystemPolicy();
      });

      it('should create an instance of SystemPolicy', function() {
        // TODO: update the code to test SystemPolicy
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.SystemPolicy);
      });
