...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataSetSchema', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.DataSetSchema();
      });

      it('should create an instance of DataSetSchema', function() {
        // TODO: update the code to test DataSetSchema
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.DataSetSchema);
      });
