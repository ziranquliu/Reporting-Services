...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataQueryFields', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataQueryFields();
      });

      it('should create an instance of ODataQueryFields', function() {
        // TODO: update the code to test ODataQueryFields
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataQueryFields);
      });
