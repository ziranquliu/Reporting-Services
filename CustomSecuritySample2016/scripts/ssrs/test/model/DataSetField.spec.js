...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataSetField', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.DataSetField();
      });

      it('should create an instance of DataSetField', function() {
        // TODO: update the code to test DataSetField
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.DataSetField);
      });
