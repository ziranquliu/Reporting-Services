...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CacheRefreshPlan', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.CacheRefreshPlan();
      });

      it('should create an instance of CacheRefreshPlan', function() {
        // TODO: update the code to test CacheRefreshPlan
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.CacheRefreshPlan);
      });
      ...
      it('should have the property catalogItemPath (base name: "CatalogItemPath")', function() {
        // TODO: update the code to test the property catalogItemPath
        expect(instance).to.have.property('catalogItemPath');
        // expect(instance.catalogItemPath).to.be(expectedValueLiteral);
      });
