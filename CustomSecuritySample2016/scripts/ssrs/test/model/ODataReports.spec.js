...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataReports', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataReports();
      });

      it('should create an instance of ODataReports', function() {
        // TODO: update the code to test ODataReports
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataReports);
      });
