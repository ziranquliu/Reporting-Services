...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OdataErrorMain', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.OdataErrorMain();
      });

      it('should create an instance of OdataErrorMain', function() {
        // TODO: update the code to test OdataErrorMain
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.OdataErrorMain);
      });
