...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataResources', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataResources();
      });

      it('should create an instance of ODataResources', function() {
        // TODO: update the code to test ODataResources
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataResources);
      });
