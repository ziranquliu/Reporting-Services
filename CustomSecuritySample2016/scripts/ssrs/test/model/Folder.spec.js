...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Folder', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.Folder();
      });

      it('should create an instance of Folder', function() {
        // TODO: update the code to test Folder
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.Folder);
      });
