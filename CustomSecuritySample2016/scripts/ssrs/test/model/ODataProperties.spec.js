...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataProperties', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataProperties();
      });

      it('should create an instance of ODataProperties', function() {
        // TODO: update the code to test ODataProperties
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataProperties);
      });
