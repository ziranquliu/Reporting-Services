...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataDataSources', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataDataSources();
      });

      it('should create an instance of ODataDataSources', function() {
        // TODO: update the code to test ODataDataSources
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataDataSources);
      });
