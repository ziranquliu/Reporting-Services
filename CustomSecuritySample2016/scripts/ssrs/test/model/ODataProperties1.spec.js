...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataProperties1', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataProperties1();
      });

      it('should create an instance of ODataProperties1', function() {
        // TODO: update the code to test ODataProperties1
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataProperties1);
      });
