...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserCredentials', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.UserCredentials();
      });

      it('should create an instance of UserCredentials', function() {
        // TODO: update the code to test UserCredentials
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.UserCredentials);
      });
