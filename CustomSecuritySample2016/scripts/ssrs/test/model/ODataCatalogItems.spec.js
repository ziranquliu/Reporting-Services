...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataCatalogItems', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataCatalogItems();
      });

      it('should create an instance of ODataCatalogItems', function() {
        // TODO: update the code to test ODataCatalogItems
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataCatalogItems);
      });
