...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataCacheRefreshPlans', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataCacheRefreshPlans();
      });

      it('should create an instance of ODataCacheRefreshPlans', function() {
        // TODO: update the code to test ODataCacheRefreshPlans
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataCacheRefreshPlans);
      });
