...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataLinkedReports', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataLinkedReports();
      });

      it('should create an instance of ODataLinkedReports', function() {
        // TODO: update the code to test ODataLinkedReports
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataLinkedReports);
      });
