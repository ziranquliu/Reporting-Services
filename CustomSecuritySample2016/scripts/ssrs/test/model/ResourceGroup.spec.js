...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResourceGroup', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ResourceGroup();
      });

      it('should create an instance of ResourceGroup', function() {
        // TODO: update the code to test ResourceGroup
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ResourceGroup);
      });
