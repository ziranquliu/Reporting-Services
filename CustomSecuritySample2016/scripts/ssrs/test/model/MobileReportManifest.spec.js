...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MobileReportManifest', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.MobileReportManifest();
      });

      it('should create an instance of MobileReportManifest', function() {
        // TODO: update the code to test MobileReportManifest
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.MobileReportManifest);
      });
      ...
      it('should have the property thumbnails (base name: "Thumbnails")', function() {
        // TODO: update the code to test the property thumbnails
        expect(instance).to.have.property('thumbnails');
        // expect(instance.thumbnails).to.be(expectedValueLiteral);
      });
