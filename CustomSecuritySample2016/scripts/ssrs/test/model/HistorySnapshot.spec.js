...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistorySnapshot', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.HistorySnapshot();
      });

      it('should create an instance of HistorySnapshot', function() {
        // TODO: update the code to test HistorySnapshot
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.HistorySnapshot);
      });
      ...
      it('should have the property historyId (base name: "HistoryId")', function() {
        // TODO: update the code to test the property historyId
        expect(instance).to.have.property('historyId');
        // expect(instance.historyId).to.be(expectedValueLiteral);
      });
