...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScheduleReference', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ScheduleReference();
      });

      it('should create an instance of ScheduleReference', function() {
        // TODO: update the code to test ScheduleReference
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ScheduleReference);
      });
