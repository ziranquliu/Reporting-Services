...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Extension', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.Extension();
      });

      it('should create an instance of Extension', function() {
        // TODO: update the code to test Extension
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.Extension);
      });

      it('should have the property extensionType (base name: "ExtensionType")', function() {
        // TODO: update the code to test the property extensionType
        expect(instance).to.have.property('extensionType');
        // expect(instance.extensionType).to.be(expectedValueLiteral);
      });
