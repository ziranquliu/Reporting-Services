...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataSetData', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.DataSetData();
      });

      it('should create an instance of DataSetData', function() {
        // TODO: update the code to test DataSetData
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.DataSetData);
      });
