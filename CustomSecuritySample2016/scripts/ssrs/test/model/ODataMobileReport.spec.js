...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataMobileReport', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataMobileReport();
      });

      it('should create an instance of ODataMobileReport', function() {
        // TODO: update the code to test ODataMobileReport
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataMobileReport);
      });
