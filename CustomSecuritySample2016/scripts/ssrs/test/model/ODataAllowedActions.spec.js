...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataAllowedActions', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataAllowedActions();
      });

      it('should create an instance of ODataAllowedActions', function() {
        // TODO: update the code to test ODataAllowedActions
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataAllowedActions);
      });
