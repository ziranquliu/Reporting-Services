...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('QueryFieldsRequest', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.QueryFieldsRequest();
      });

      it('should create an instance of QueryFieldsRequest', function() {
        // TODO: update the code to test QueryFieldsRequest
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.QueryFieldsRequest);
      });
