...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataFolders', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataFolders();
      });

      it('should create an instance of ODataFolders', function() {
        // TODO: update the code to test ODataFolders
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataFolders);
      });
