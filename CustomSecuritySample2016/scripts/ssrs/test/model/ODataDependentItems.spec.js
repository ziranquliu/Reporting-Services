...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ODataDependentItems', function() {
      beforeEach(function() {
        instance = new SqlServer2017ReportingServicesRestApi.ODataDependentItems();
      });

      it('should create an instance of ODataDependentItems', function() {
        // TODO: update the code to test ODataDependentItems
        expect(instance).to.be.a(SqlServer2017ReportingServicesRestApi.ODataDependentItems);
      });
