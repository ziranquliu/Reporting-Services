...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SqlServer2017ReportingServicesRestApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://localhost/reports/api/v2.0
     */
    this.basePath = 'http://localhost/reports/api/v2.0'.replace(/\/+$/, '');
