...
namespace IO.PBIRS.Swagger.Test
{
    ...
    public class ReportsApiTests
    {
        ...
        /// <summary>
        /// Test UpdateReportDataSets
        /// </summary>
        [Test]
        public void UpdateReportDataSetsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //SharedDataSets dataSets = null;
            //instance.UpdateReportDataSets(id, dataSets);
        ...
        public void UploadReportTest()
        {
            ...
            //var response = instance.UploadReport(id, _file);
            //Assert.IsInstanceOf<Report> (response, "response is Report");
        }
