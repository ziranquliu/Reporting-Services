<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="CustomSecuritySampleWeb.HomePage" %>

<%@ Import Namespace="CustomSecuritySampleWeb" %>
...
<body>
    ...
    <div style="float:left; bottom:5px; position:absolute; font-size:11px;"><%=Service2010.GetReportServerConfigInfo(true) %> 
        <%=GetSecurityScopes() %>
        <%=GetModelItemTypes() %>
        <%=GetItemTypes() %>
    </div>
